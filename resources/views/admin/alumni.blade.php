                ...
                <div class="table-data__tool">
                    <div class="table-data__tool-right">
                        <button class="au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="modal"
                            data-target="#tambahAlumni">
                            <i class="zmdi zmdi-plus"></i>Tambah Data
                        </button>
                        <button class="au-btn au-btn-icon au-btn--blue au-btn--small" data-toggle="modal"
                            data-target="#importAlumni">
                            <i class="zmdi zmdi-upload"></i>Import Data
                        </button>
                        <button class="au-btn au-btn-icon au-btn--blue2 au-btn--small"><a
                                href="{{ route('export.alumni') }}" style="text-decoration: none; color: white;">
                        ...
                        <tbody style="text-align: center;">
                            ...
                            <td>
                                <div class="table-data-feature">
                                    <button class="item btn btn-primary" data-placement="top"
                                        onClick="editAlumni('{{ $data->id }}')" title="Edit Data Alumni">
                                        <i class="zmdi zmdi-edit"></i>
                                    </button>
                                    <button class="item btn btn-danger" onClick="hapusAlumni('{{ $key }}')"
                                        data-placement="top" title="Hapus Data Alumni" data-toggle="modal"
                                        data-target="#hapusAlumni">
...
function editAlumni(id) {
    ...
    $.ajax({
        ...
        $("#previewAlumni").append("<img src='./images/users/" + gambar +
            "' class='contentimg' id='fotoAlumniTampil'>");
...
@section('modal')
<!-- Modal Tambah Alumni -->
<div class="modal fade" id="tambahAlumni" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('alumni.store') }}" id="frmTmbAlumni" method="post" enctype="multipart/form-data"
                class="form-horizontal">@csrf
                <div class="modal-body">
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="nim-input" class="form-control-label">NIM</label></div>
                        <div class="col-12 col-md-9"><input type="text" id="nim-input" name="nim" class="form-control"
                                autocomplete="off"></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="nama-input" class="form-control-label">Nama Alumni</label>
                        </div>
                        <div class="col-12 col-md-9"><input type="text" id="nama-input" name="nama_alumni"
                                class="form-control" autocomplete="off"></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="tmpLahir-input" class="form-control-label">Tempat
                                Lahir</label></div>
                        <div class="col-12 col-md-9"><input type="text" id="tmpLahir-input" name="tmp_lahir"
                                class="form-control" autocomplete="off"></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="tglLahir-input" class=" form-control-label">Tanggal
                                Lahir</label></div>
                        <div class="col-12 col-md-9">
                            <input type="text" id="tglLahir-input" name="tgl_lahir" class="form-control datepicker"
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="alamat-input" class=" form-control-label">Alamat</label>
                        </div>
                        <div class="col-12 col-md-9"><textarea name="alamat" id="alamat-input" rows="5"
                                class="form-control"></textarea></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="fotoAlumni-input" class=" form-control-label">Foto
                                Alumni</label></div>
                        <div class="col-12 col-md-9">
                            <img id="fotoAlumni" src="./images/users/no-image.png" style="width: 40%;">
                            <input type="file" id="fotoAlumni-input" name="foto_alumni" class=" form-control"
                                accept="image/*">
                        </div>
                    </div>
                </div>
...
<!-- Modal Edit Alumni -->
<div class="modal fade" id="editAlumni" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('alumni.update') }}" id="frmEditAlumni" method="post" enctype="multipart/form-data"
                class="form-horizontal">@csrf
                <input type="hidden" name="idEdit" id="idEdit">
                <div class="modal-body">
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="nim-edit" class="form-control-label">NIM</label></div>
                        <div class="col-12 col-md-9"><input type="text" id="nim-edit" name="nim" class="form-control"
                                autocomplete="off"></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="nama-edit" class="form-control-label">Nama Alumni</label>
                        </div>
                        <div class="col-12 col-md-9"><input type="text" id="nama-edit" name="nama_alumni"
                                class="form-control" autocomplete="off"></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="tmpLahir-edit" class="form-control-label">Tempat
                                Lahir</label></div>
                        <div class="col-12 col-md-9"><input type="text" id="tmp-edit" name="tmp_lahir"
                                class="form-control" autocomplete="off"></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="tglLahir-edit" class=" form-control-label">Tanggal
                                Lahir</label></div>
                        <div class="col-12 col-md-9">
                            <input type="text" id="tgl-edit" name="tgl_lahir" class="datepicker form-control"
                                autocomplete="off" readonly="">
                        </div>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><textarea name="alamat" id="alamat-edit" rows="5"
                                class="form-control"></textarea></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="fotoAlumni-edit" class=" form-control-label">Foto
                                Alumni</label></div>
                        <div class="col-12 col-md-9">
                            <div id="previewAlumni" style="width: 40%;"></div>
                            <input type="file" id="fotoAlumni-edit" name="foto_alumni" class=" form-control"
                                accept="image/*">
                        </div>
                    </div>
                </div>
...
<!-- Modal Hapus Alumni -->
<div class="modal fade" id="hapusAlumni" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel"
    aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div id="modalMdContent">
                    <h4 class="text-center">Apakah anda yakin ingin menghapus data alumni <span
                            class="modalNama"></span>?</h4>
                </div>
            </div>
            <div class="modal-footer">
...
<!-- Modal Import Alumni -->
<div class="modal fade" id="importAlumni" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel"
    aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="{{ route('import.alumni') }}" id="frmImportAlumni" method="post" enctype="multipart/form-data"
                class="form-horizontal">@csrf
                <div class="modal-body">
                    <div id="modalMdContent">
                        <div class="sufee-alert alert alert-info">
                            Silakan Download Template Excel dan Lengkapi Datanya!
                            <span class="badge badge-pill badge-success"><i class="fa fa-download"></i><a
                                    href="{{ asset('file/Temp_Alumni.xlsx') }}"
                                    style="color: white;">&nbsp;&nbsp;Download Template</a></span>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="file-input" class="form-control-label">Pilih
                                    File</label></div>
                            <div class="col-12 col-md-9">
...
$(document).ready(function() {
    ...
    $('#frmImportAlumni').validate({
        ...
        messages: {
            file_import: {
                required: "Tidak File Dipilih",
                extension: "Ekstensi Harus *.xlsx atau *.xls"
            }
        },
    ...
    $("#frmTmbAlumni").validate({
        ...
        messages: {
            nim: {
                ...
                digits: "Harus Digit Angka",
                minlength: "Panjang 10 Karakter",
                maxlength: "Panjang 10 Karakter"
            },
            nama_alumni: {
                required: "Harus Diisi"
            },

...
<div class="modal fade" id="tambahPengumuman" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('pengumuman.store') }}" id="frmTmbPengumuman" enctype="multipart/form-data"
                class="form-horizontal">@csrf
                <div class="modal-body">
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="judul-input" class=" form-control-label">Judul
                                Pengumuman</label></div>
                        <div class="col-12 col-md-9">
                            <input type="text" id="judul-pengumuman" name="judul_pengumuman" class="form-control"
                                autocomplete="off" autofocus required="">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="isi-input" class=" form-control-label">Isi
                                Pengumuman</label></div>
                        <div class="col-12 col-md-9">
                            <textarea id="isi-pengumuman" name="isi_pengumuman" class="form-control"
                                required=""></textarea>
                            <div id="errorIsiInput"></div>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="tanggal-input" class=" form-control-label">Tgl.
                                Pengumuman</label></div>
                        <div class="col-12 col-md-9">
                            <input type="text" id="tgl-pengumuman" name="tgl_pengumuman" class="form-control"
                                readonly="">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="gambar-input"
                                class=" form-control-label">Thumbnail</label></div>
                        <div class="col-12 col-md-9">
                            <input type="file" id="gambar-pengumuman" name="gambar_pengumuman" class="form-control file"
                                data-theme="fas" accept="image/*">
                            <div id="errorInput"></div>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="lampiran-input"
                                class=" form-control-label">Lampiran</label></div>
                        <div class="col-12 col-md-9">
                            <input type="file" id="lampiran-pengumuman" name="lampiran_pengumuman[]"
                                class="form-control file" multiple data-theme="fas">
                        </div>
                    </div>
                </div>
...
<!-- Modal Edit Pengguna -->
<div class="modal fade" id="editPengguna" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel"
    aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="{{ route('pengguna.update') }}" id="frmEditPengguna" method="post"
                enctype="multipart/form-data" class="form-horizontal">@csrf
                <input type="hidden" name="idEdit" id="idEditUser">
                <div class="modal-body">
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="nama-edit" class=" form-control-label">Nama
                                Lengkap</label></div>
                        <div class="col-12 col-md-9"><input type="text" id="namaLengkap-edit" name="nama"
                                class="form-control" autocomplete="off"></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="username-edit"
                                class=" form-control-label">Username</label></div>
                        <div class="col-12 col-md-9"><input type="text" id="username-edit" name="username"
                                class="form-control" readonly=""></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="email-edit" class=" form-control-label">Email</label>
                        </div>
                        <div class="col-12 col-md-9"><input type="text" id="email-edit" name="email"
                                class=" form-control" autocomplete="off"></div>
                    </div>
                    <div class="row form-group">
                            ...
                            <div class="form-check">
                                ...
                                <div class="radio">
                                    <label for="status-input" class="form-check-label ">
                                        <input type="radio" id="status{{ $data->id }}" name="status"
                                            value="{{ $data->id }}" class="form-check-input">{{ $data->status }}
                                    </label>
                                </div>
                                @endforeach
                            </div>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="foto-edit" class=" form-control-label">Foto Profil</label>
                        </div>
                        <div class="col-12 col-md-9">
...
<div class="modal fade" id="hapusPengguna" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel"
    aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div id="modalMdContent">
                    <h4 class="text-center">Apakah anda yakin ingin menghapus data pengguna <span
                            class="namaPengguna"></span>?</h4>
                </div>
            </div>
            <div class="modal-footer">
